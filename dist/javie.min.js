...
function e(){var n=void 0===arguments[0]?"production":arguments[0];u(this,e),this.config={},this.environment="production",this.instances={},this.config={},
this.environment=n,this.instances={}}return i(e,[{key:"detectEnvironment",value:function(e){return s.isFunction(e)&&(e=e.apply(this)),this.environment=e;
}},{key:"env",value:function(){return this.environment}},{key:"get",value:function(e){var n=void 0===arguments[1]?null:arguments[1];return"undefined"!=typeof this.config[e]?this.config[e]:n;
