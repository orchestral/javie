...
e.prototype.forget=function(e){var t,n,o,u;if(o=this,t=e.id,u=e.callback,!i.isString(t))throw new Error("Event ID ["+t+"] is not provided");if(!i.isFunction(u))throw new Error("Callback is not a function");
...
this.put({object:t}),p=e.split(" "),1===p.length?c=p[0]:(-1!==l.indexOf(u,p[0])&&(f=p[0]),c=p[1],"GET"!==f&&(i=c.split("?"),i.length>1&&(c=i[0],this.put({
