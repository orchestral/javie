...
query:i[1]}))),c=c.replace(":baseUrl",this.get("baseUrl","")),this.put({type:f,uri:c})),o=n(t).attr("id"),"undefined"!=typeof o&&this.put({id:"#"+o}),this;
},e.prototype.execute=function(e){var t,o,u;return t=this,o=this.get("name"),l.isObject(e)||(e=""+n(this.get("object")).serialize()+"&"+this.get("query"),
