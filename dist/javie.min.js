...
this.config={name:"",type:"GET",uri:"",query:"",data:"",dataType:"json",id:"",object:null,headers:{}}}return a(e,[{key:"get",value:function(e){var n=void 0===arguments[1]?null:arguments[1];
...
this}},{key:"addHeader",value:function(e,n){var t=this.get("headers",{});return t[e]=n,this.put({headers:t}),this}},{key:"to",value:function(e,n){var t=void 0===arguments[2]?"json":arguments[2],r=void 0===arguments[3]?{}:arguments[3],u=["POST","GET","PUT","DELETED"];
...
},complete:function(r){e=o(r.responseText),status=r.status,n.response=r,!v.isUndefined(e)&&e.hasOwnProperty("error")&&(n.fireEvent("onError",t,[e.errors,status,n]),
