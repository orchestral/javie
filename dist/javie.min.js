...
return new c["default"]}),p.bind("profiler",function(e){return null!=e?v["default"](e):v["default"]}),p.bind("request",function(e){return null!=e?g["default"](e):g["default"];
}),window.Javie=p},{"./Application.es6":2,"./modules/events/Events.es6":4,"./modules/log/Log.es6":5,"./modules/profiler/Profiler.es6":6,"./modules/request/Request.es6":7,
"./vendor/underscore":9}],2:[function(e,n,t){"use strict";function r(e){if(e&&e.__esModule)return e;var n={};if(null!=e)for(var t in e)Object.prototype.hasOwnProperty.call(e,t)&&(n[t]=e[t]);
...
function e(n,t){var r=void 0===arguments[2]?!1:arguments[2],i=void 0===arguments[3]?!1:arguments[3];u(this,e),this.name=null,this.instance=null,this.shared=!1,
this.resolved=!1,this.name=n,this.instance=t,this.shared=r,this.resolved=i}return i(e,[{key:"resolving",value:function(){var e=void 0===arguments[0]?[]:arguments[0];
...
function e(){u(this,e),this.config={},this.environment="production",this.instances={}}return i(e,[{key:"detectEnvironment",value:function(e){return s.isFunction(e)&&(e=e.apply(this)),
