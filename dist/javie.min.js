...
if(v["default"].isString(e))try{e=h["default"].parseJSON(e)}catch(n){e=null}return e}var o=function(){function e(e,n){for(var t=0;t<n.length;t++){var r=n[t];
...
r&&e(n,r),n}}();Object.defineProperty(t,"__esModule",{value:!0});var s=e("../events/Events.es6"),l=u(s),f=e("../config/Config.es6"),c=(u(f),e("../../helpers")),d=(r(c),
e("../../vendor/underscore")),v=u(d),g=e("../../vendor/jquery"),h=u(g),m=l["default"].make(),p={},y=function(){function e(){i(this,e),this.executed=!1,
this.response=null,this.config=new Configuration({name:"",type:"GET",uri:"",query:"",data:"",dataType:"json",id:"",object:null,headers:{},beforeSend:function(){},
...
if(v["default"].isUndefined(e))throw new Error("Missing required URL parameter.");null==n&&(n=window.document);var i=e.split(" "),a=e,o=this.config.get("type","POST"),s=this.config.get("query","");
...
this.config.put({dataType:t,object:n,query:s,type:o,uri:a,headers:r});var f=h["default"](n).attr("id");return"undefined"!=typeof f&&this.config.put({id:"#"+f
}),this}},{key:"execute",value:function(e){var n=this,t=this.config.get("name"),r=this.config.get("object"),u=this.config.get("query");v["default"].isObject(e)||(e=h["default"](r).serialize()+"&"+u,
...
beforeSend:function(e){n.fireEvent("beforeSend",t,[n,e])},complete:function(r){e=a(r.responseText),status=r.status,n.response=r,!v["default"].isUndefined(e)&&e.hasOwnProperty("error")&&(n.fireEvent("onError",t,[e.errors,status,n,r]),
e.errors=null),n.fireEvent("onComplete",t,[e,status,n,r])}};return h["default"].ajax(i),this}},{key:"fireEvent",value:function(e,n,t){m.fire("Request."+e,t),
m.fire("Request."+e+": "+n,t);var r=this.config[e];v["default"].isFunction(r)&&r.apply(this,t)}}]),e}(),k={baseUrl:null,onError:function(e,n){},beforeSend:function(e,n){},
onComplete:function(e,n){}},b=function(){function e(n){return i(this,e),e.make(n)}return o(e,null,[{key:"make",value:function(){var n=arguments.length<=0||void 0===arguments[0]?"default":arguments[0];
return e.find(n)}},{key:"get",value:function(e){var n=arguments.length<=1||void 0===arguments[1]?null:arguments[1];return v["default"].isUndefined(k[e])?n:k[e];
}},{key:"put",value:function(e,n){var t=e;v["default"].isObject(e)||(t={},t[e]=n),k=v["default"].defaults(t,k)}},{key:"find",value:function(e){var n=null;
if(v["default"].isUndefined(p[e]))return n=new y,n.put(v["default"].defaults(n.config.all(),k)),n.put({name:e}),p[e]=n;if(n=p[e],!n.executed)return n;var t=(v["default"].uniqueId(e+"_"),
new y);return m.clone("Request.onError: "+e).to("Request.onError: "+e),m.clone("Request.onComplete: "+e).to("Request.onComplete: "+e),m.clone("Request.beforeSend: "+e).to("Request.beforeSend: "+e),
t.put(n.config),t}}]),e}();t["default"]=b},{"../../helpers":3,"../../vendor/jquery":9,"../../vendor/underscore":10,"../config/Config.es6":4,"../events/Events.es6":5
