...
if(g.isString(e))try{e=h.parseJSON(e)}catch(n){e=null}return e}var o=function(){function e(e,n){for(var t=0;t<n.length;t++){var r=n[t];r.enumerable=r.enumerable||!1,
...
value:!0});var s=e("../events/Events.es6"),l=u(s),f=e("../config/Config.es6"),c=(u(f),e("../../helpers")),d=(r(c),l["default"].make()),v={},g=e("../../vendor/underscore"),h=e("../../vendor/jquery"),m=function(){
...
if(g.isUndefined(e))throw new Error("Missing required URL parameter.");null==n&&(n=window.document);var i=e.split(" "),a=e,o=this.config.get("type","POST"),s=this.config.get("query","");
if(1==i.length?a=i[0]:(g.indexOf(u,i[0])>-1&&(o=i[0]),a=i[1]),"GET"!=o){var l=a.split("?");l.length>1&&(a=l[0],s=l[1])}a=a.replace(":baseUrl",this.config.get("baseUrl","")),
this.config.put({dataType:t,object:n,query:s,type:o,uri:a,headers:r});var f=h(n).attr("id");return"undefined"!=typeof f&&this.config.put({id:"#"+f}),this;
}},{key:"execute",value:function(e){var n=this,t=this.config.get("name"),r=this.config.get("object"),u=this.config.get("query");g.isObject(e)||(e=h(r).serialize()+"&"+u,
...
beforeSend:function(e){n.fireEvent("beforeSend",t,[n,e])},complete:function(r){e=a(r.responseText),status=r.status,n.response=r,!g.isUndefined(e)&&e.hasOwnProperty("error")&&(n.fireEvent("onError",t,[e.errors,status,n,r]),
e.errors=null),n.fireEvent("onComplete",t,[e,status,n,r])}};return h.ajax(i),this}},{key:"fireEvent",value:function(e,n,t){d.fire("Request."+e,t),d.fire("Request."+e+": "+n,t);
var r=this.config[e];g.isFunction(r)&&r.apply(this,t)}}]),e}(),p={baseUrl:null,onError:function(e,n){},beforeSend:function(e,n){},onComplete:function(e,n){}
...
return e.find(n)}},{key:"get",value:function(e){var n=arguments.length<=1||void 0===arguments[1]?null:arguments[1];return g.isUndefined(p[e])?n:p[e]}},{
key:"put",value:function(e,n){var t=e;g.isObject(e)||(t={},t[e]=n),p=g.defaults(t,p)}},{key:"find",value:function(e){var n=null;if(g.isUndefined(v[e]))return n=new m,
n.put(g.defaults(n.config.all(),p)),n.put({name:e}),v[e]=n;if(n=v[e],!n.executed)return n;var t=(g.uniqueId(e+"_"),new m);return d.clone("Request.onError: "+e).to("Request.onError: "+e),
